    ...
    <div class="mx-auto max-w-(--breakpoint-xl)">
        <div class="md:flex md:justify-between">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div></div>
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase">Contact Details</h2>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center" title="{{config('app.version')}}">© {{now()->year}} <a href="#"
